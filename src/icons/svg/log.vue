...
<template>
  <svg t="1687836040322" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
       p-id="13733" width="200" height="200">
    <path
    ...
    <path
      ...
      p-id="13735"></path>
    <path d="M785.26 742.45h-96.55V617.36h28.19v96.9h68.36v28.19z" p-id="13736"></path>
  </svg>
</template>
